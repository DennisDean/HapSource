function fig_exists = does_figure_exist(fig_id)
% does_figure_exist
%
% function determines if figure still exists
%
%
...
% check figure handles for figure id 
hands     = get (0,'Children');
fig_exists = ismember(fig_id, hands);