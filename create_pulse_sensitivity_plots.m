function fig_ids = create_pulse_sensitivity_plots ...
...
% add sensitivity information to interactive table 1 for viewing                           
interactive_table_struct_1 = add_number_of_peaks_to_generate...
    (interactive_table_struct_1,interactive_table_struct_2,...
     hormone_database_1, hormone_database_2);

% Create XY Plots
fig_info_3 = plot_xy_from_inter_table_with_comparison...
    (interactive_table_struct_1,interactive_table_struct_2, upper_left_corner);

% Define output argument
fig_ids = fig_info_3.fig_id_hist;
summary_info = fig_info_3.fig_fns;

%---------------------------------
% create save structure
save_fig_struct.fig_description = 'sensitivity_anlaysis_';
