function [fig_ids vs ax1s ax2s]= create_multiple_individual_hormone_w_same_scale_sleep_plots(varargin)
...
elseif nargin == 3
    ...
    hormone_plot_spec = varargin{3};
    
    % Get hormone plot paramters from stucture
    time_adj_F = hormone_plot_spec.time_translation;
...
for s = 1:num_subjects
    ...
    if nargin >= 3
        ...
        if isfield(hormone_plot_spec,'figure_limits')
            hormone_plot.figure_limits = hormone_plot_spec.figure_limits;
        end    
    end
