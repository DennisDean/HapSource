function save_mat_file(pulse_library, pulse_library_fn, pulse_library_pn)
% save_mat_file
%
% Save's a mat file to passed in name
%
...
temp_fn = 'temp.mat';
save 'temp.mat' pulse_library;
source = strcat(pulse_library_pn,temp_fn); 
dest = strcat(pulse_library_pn,pulse_library_fn);
