function data_cell = float2cell(data,dim)
% float2cell
%
% Converts two column vector array to cell array for interactive
% processing. Function is clearly a hack to get results quickly. Note that
% the dimension variable is not used.
%
%
