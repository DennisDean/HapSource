function fig_ids = specify_hormone_database_plots(hormone_plot_spec)
...
if isfield(hormone_plot_spec, 'scale_y')
    if hormone_plot_spec.scale_y == 1
        ...
        [fig_ids vs] = create_individual_hormone_w_sleep_plots...
...
vs = rescale_figures(fig_ids, plot_scale_function, max_struct);
