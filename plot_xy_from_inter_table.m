function fig_info = plot_xy_from_inter_table ...
    (interactive_table_struct,upper_left_corner)
...
S_CHAR = 's';
CONTROL_COLOR = [0 0 1];
FIBRYMYALGIA_COLOR = [1 0 1];
ACTH_Y_LIMIT = [.1 1000];
CORT_Y_LIMIT = [0.01 100];
ACTH_X_LIMIT = [0 140];
CORT_X_LIMIT = [0 250];    
...
fig_info.fig_fns = cell(10,1);
fig_info.fig_id_hist = zeros(10,1);
...
% Plot amp_width vs. amp_rise control only
fig_descr = 'xy_descent_amp_control';
plot_type = 'Clearance Proxy';
...
% Plot amp_width vs. amp_rise fibrymyalgia only
fig_descr = 'xy_descent_width_fibryo';
plot_type = 'Clearance Proxy';
...
% Plot amp_width vs. amp_rise control only
fig_descr = 'xy_descent_amp_control_indiv';
plot_type = 'Clearance Proxy';
...
% Plot amp_width vs. amp_rise fibrymyalgia only
fig_descr = 'xy_descent_width_fibryo_indiv';
plot_type = 'Clearance Proxy';
...
% Plot amp_width vs. amp_rise fibrymyalgia only
fig_descr = 'xy_descent_width_fibryo_sleep_wake';
plot_type = 'Clearance Proxy';
